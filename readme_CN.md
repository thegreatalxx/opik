...
| **Agent Spec**            | 记录 Agent Spec 调用的跟踪                      | [文档](https://www.comet.com/docs/opik/integrations/agentspec?utm_source=opik&utm_medium=github&utm_content=agentspec_link&utm_campaign=opik)                         |
...
| **OpenClaw**              | 记录 OpenClaw 智能体运行的跟踪                  | [文档](https://www.comet.com/docs/opik/integrations/openclaw?utm_source=opik&utm_medium=github&utm_content=openclaw_link&utm_campaign=opik) |
