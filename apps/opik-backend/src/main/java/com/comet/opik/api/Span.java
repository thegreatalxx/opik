...
public record Span(
        ...
        @JsonView({Span.View.Public.class, Span.View.Write.class,
                ExperimentItemBulkUpload.View.ExperimentItemBulkWriteView.class}) Instant createdAt,
        @JsonView({Span.View.Public.class, Span.View.Write.class,
        ...
        @JsonView({Span.View.Public.class, Span.View.Write.class,
                ExperimentItemBulkUpload.View.ExperimentItemBulkWriteView.class}) String createdBy,
        @JsonView({Span.View.Public.class, Span.View.Write.class,
                ExperimentItemBulkUpload.View.ExperimentItemBulkWriteView.class}) String lastUpdatedBy,
        @JsonView({
