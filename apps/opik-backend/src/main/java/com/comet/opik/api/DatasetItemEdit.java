...
public record DatasetItemEdit(
        @JsonView(DatasetItemEdit.View.Write.class) @NotNull @Schema(description = "Stable dataset item identifier (dataset_item_id). Remains the same across dataset versions", required = true) UUID id,
