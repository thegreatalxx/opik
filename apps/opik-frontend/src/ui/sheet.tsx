  ...
  return (
    <SheetPortal container={container}>
      ...
      <SheetPrimitive.Content
        ...
        {...props}
      >
        <div className="border-b-border flex h-[60px] items-center border-b px-6">
          <Button asChild size="icon-sm" variant="outline">
            <SheetPrimitive.Close className="ring-offset-background focus:ring-ring data-[state=open]:bg-secondary rounded-sm opacity-70 transition-opacity hover:opacity-100 focus:outline-none focus:ring-2 focus:ring-offset-2 disabled:pointer-events-none">
              <X />
