...
>(({ className, ...props }, ref) => (
  <div className="relative w-full">
    <table
      ref={ref}
      className={cn(
        "comet-table w-full caption-bottom text-sm table-fixed",
        className,
      )}
      {...props}
    />
...
>(({ className, ...props }, ref) => (
  <td
    ref={ref}
    className={cn(
      "comet-fix-cell-height relative p-0 align-middle [&:has([role=checkbox])]:pr-0 [&:first-child_[data-cell-wrapper=true]]:pl-5 [&:last-child_[data-cell-wrapper=true]]:pr-5 group-hover/row:bg-primary-foreground group-data-[state=selected]/row:bg-row-selected",
      className,
    )}
    {...props}
  />
