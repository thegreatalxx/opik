...
import AddTestSuiteSidebar from "@/v2/pages-shared/datasets/AddTestSuiteSidebar/AddTestSuiteSidebar";
...
import {
  ...
  TYPE_LABELS,
} from "@/v2/pages/TestSuitesPage/columns";
import TextCell from "@/shared/DataTableCells/TextCell";
import DatasetTypeCell from "@/v2/pages/TestSuitesPage/DatasetTypeCell";
...
const TestSuiteRowActionsCell = createDatasetRowActionsCell({
  entityName: "test suite",
  EditDialog: AddEditTestSuiteDialog,
});

const getRowId = (d: Dataset) => d.id;

const SELECTED_COLUMNS_KEY = "test-suites-selected-columns";
const SELECTED_COLUMNS_KEY_V2 = `${SELECTED_COLUMNS_KEY}-v2`;
const SELECTED_COLUMNS_KEY_V3 = `${SELECTED_COLUMNS_KEY}-v3`;
const COLUMNS_WIDTH_KEY = "test-suites-columns-width";
const COLUMNS_ORDER_KEY = "test-suites-columns-order";
const COLUMNS_SORT_KEY = "test-suites-columns-sort";
const PAGINATION_SIZE_KEY = "test-suites-pagination-size";
