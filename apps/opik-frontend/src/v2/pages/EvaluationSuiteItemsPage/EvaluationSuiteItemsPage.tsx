...
import EvaluationSuiteItemsTab from "@/v2/pages/EvaluationSuiteItemsPage/EvaluationSuiteItemsTab/EvaluationSuiteItemsTab";
import EditEvaluationSuiteSettingsDialog from "@/v2/pages/EvaluationSuiteItemsPage/EditEvaluationSuiteSettingsDialog";
