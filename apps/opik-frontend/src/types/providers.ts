...
export enum PROVIDER_MODEL_TYPE {
  ...
  ALLENAI_OLMO_3_1_32B_INSTRUCT = "allenai/olmo-3.1-32b-instruct",
  ALLENAI_OLMO_3_1_32B_THINK = "allenai/olmo-3.1-32b-think",
  ...
  LIQUID_LFM_2_5_1_2B_INSTRUCT_FREE = "liquid/lfm-2.5-1.2b-instruct:free",
  LIQUID_LFM_2_5_1_2B_THINKING_FREE = "liquid/lfm-2.5-1.2b-thinking:free",
  ...
  MISTRALAI_MINISTRAL_14B_2512 = "mistralai/ministral-14b-2512",
  MISTRALAI_MINISTRAL_3B = "mistralai/ministral-3b",
  MISTRALAI_MINISTRAL_3B_2512 = "mistralai/ministral-3b-2512",
  MISTRALAI_MINISTRAL_8B = "mistralai/ministral-8b",
  MISTRALAI_MINISTRAL_8B_2512 = "mistralai/ministral-8b-2512",
  ...
  MISTRALAI_MISTRAL_SMALL_CREATIVE = "mistralai/mistral-small-creative",
  ...
  QWEN_QWEN3_NEXT_80B_A3B_INSTRUCT_FREE = "qwen/qwen3-next-80b-a3b-instruct:free",
  ...
  VERTEX_AI_GEMINI_2_5_PRO_EXP_03_25 = "vertex_ai/gemini-2.5-pro-exp-03-25",
  VERTEX_AI_GEMINI_2_5_PRO_PREVIEW_03_25 = "vertex_ai/gemini-2.5-pro-preview-03-25",
