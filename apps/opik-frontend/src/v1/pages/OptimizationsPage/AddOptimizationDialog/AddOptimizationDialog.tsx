...
import GoogleColabCard from "@/v1/pages-shared/onboarding/GoogleColabCard/GoogleColabCard";
import ConfiguredCodeHighlighter from "@/v1/pages-shared/onboarding/ConfiguredCodeHighlighter/ConfiguredCodeHighlighter";
      ...
      <div className="pb-20">
        <div className="pb-8">
          ...
          <div className="comet-body-s m-auto mt-4 w-[468px] self-center text-center text-muted-slate">
            Select an test suite, choose the optimizer you would like to use,
            and we will improve your prompt for you
          </div>
        </div>
