...
import AddEditRuleDialog from "@/v1/pages-shared/automations/AddEditRuleDialog/AddEditRuleDialog";
import DataTablePagination from "@/shared/DataTablePagination/DataTablePagination";
import MetricSelector from "./MetricSelector";
import { DatasetVersionSelectBox } from "@/v1/pages-shared/DatasetVersionSelectBox";
import { parseDatasetVersionKey } from "@/utils/datasetVersionStorage";
import PlaygroundProgressIndicator from "@/v1/pages/PlaygroundPage/PlaygroundOutputs/PlaygroundProgressIndicator";
...
const PlaygroundOutputActions = ({
  ...
  useEffect(() => {
    setSelectedRuleIds(datasetId ? [] : null);
