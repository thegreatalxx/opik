...
[installation instructions](https://oracle.github.io/agent-spec/development/installation.html#extra-dependencies).

### Configuring Opik

Configure the Opik Python SDK for your deployment type.
See the [Python SDK Configuration guide](/tracing/sdk_configuration) for detailed instructions on:
