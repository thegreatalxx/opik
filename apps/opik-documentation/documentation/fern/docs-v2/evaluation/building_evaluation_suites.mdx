---
headline: Building Evaluation Suites | Opik Documentation
og:description: Create and manage Evaluation Suites using the SDK, UI, or Ollie to build
  regression tests from real production failures
og:site_name: Opik Documentation
og:title: Building Evaluation Suites — Opik
title: Building Evaluation Suites
---

Evaluation suites grow as you debug and improve your agent. There are three ways to build them: with Ollie, through the UI, or via the SDK.
...
In the Opik dashboard, navigate to the Evaluation Suites section to create and manage suites visually. You can add test items, define assertions, configure execution policies, and review results — all without writing code.
