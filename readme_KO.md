...
| **Agent Spec**            | Agent Spec 호출 트레이스                              | [문서](https://www.comet.com/docs/opik/integrations/agentspec?utm_source=opik&utm_medium=github&utm_content=agentspec_link&utm_campaign=opik)                         |
...
| **OpenClaw**              | OpenClaw 에이전트 실행 트레이스                  | [문서](https://www.comet.com/docs/opik/integrations/openclaw?utm_source=opik&utm_medium=github&utm_content=openclaw_link&utm_campaign=opik) |
