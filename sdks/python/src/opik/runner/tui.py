...
# Orange → Red gradient endpoints (from prefixed_output.py)
...
class RunnerTUI:
    ...
    def op_start(self, command_id: str, command_type: str, summary: str) -> None:
        entry = _OpEntry(command_id=command_id, command_type=command_type, summary=summary)
        with self._lock:
    ...
    def op_end(self, command_id: str, success: bool, error: Optional[str] = None) -> None:
        with self._lock:
