...
export class RunnersClient {
     ...
     *
     * @param {OpikApi.PairCompleteRequest} request
     * @param {RunnersClient.RequestOptions} requestOptions - Request-specific configuration.
     *
     * @throws {@link OpikApi.NotFoundError}
     *
     * @example
     *     await client.runners.completePairing({
     *         projectId: "project_id"
     *     })
     */
    public completePairing(
        request: OpikApi.PairCompleteRequest,
        requestOptions?: RunnersClient.RequestOptions,
    ): core.HttpResponsePromise<OpikApi.LocalRunnerConnectResponse> {
        return core.HttpResponsePromise.fromPromise(this.__completePairing(request, requestOptions));
    }

    private async __completePairing(
        request: OpikApi.PairCompleteRequest,
        requestOptions?: RunnersClient.RequestOptions,
        ...
        const _response = await core.fetcher({
            ...
            queryParameters: requestOptions?.queryParams,
            requestType: "json",
            body: serializers.PairCompleteRequest.jsonOrThrow(request, {
                unrecognizedObjectKeys: "strip",
                omitUndefined: true,
            }),
            timeoutMs: (requestOptions?.timeoutInSeconds ?? this._options?.timeoutInSeconds ?? 60) * 1000,
     ...
     *
     * @param {OpikApi.GetPakeMessagesRequest} request
     * @param {RunnersClient.RequestOptions} requestOptions - Request-specific configuration.
     *
     * @throws {@link OpikApi.NotFoundError}
     *
    ...
    public getPakeMessages(
        request: OpikApi.GetPakeMessagesRequest,
        requestOptions?: RunnersClient.RequestOptions,
    ): core.HttpResponsePromise<OpikApi.PakeMessageResponse[]> {
        return core.HttpResponsePromise.fromPromise(this.__getPakeMessages(request, requestOptions));
    }

    private async __getPakeMessages(
        request: OpikApi.GetPakeMessagesRequest,
        requestOptions?: RunnersClient.RequestOptions,
    ): Promise<core.WithRawResponse<OpikApi.PakeMessageResponse[]>> {
        const { projectId, afterStep, role } = request;
        const _queryParams: Record<string, unknown> = {
        ...
        if (_response.ok) {
            return {
                data: serializers.runners.getPakeMessages.Response.parseOrThrow(_response.body, {
                    unrecognizedObjectKeys: "passthrough",
                    allowUnrecognizedUnionMembers: true,
                    allowUnrecognizedEnumValues: true,
                    skipValidation: true,
     ...
     *
     * @param {OpikApi.PakeMessageRequest} request
     * @param {RunnersClient.RequestOptions} requestOptions - Request-specific configuration.
     *
     * @throws {@link OpikApi.NotFoundError}
     * @throws {@link OpikApi.TooManyRequestsError}
     ...
     *     })
     */
    public postPakeMessage(
        request: OpikApi.PakeMessageRequest,
        requestOptions?: RunnersClient.RequestOptions,
    ): core.HttpResponsePromise<void> {
        return core.HttpResponsePromise.fromPromise(this.__postPakeMessage(request, requestOptions));
    }

    private async __postPakeMessage(
        request: OpikApi.PakeMessageRequest,
        requestOptions?: RunnersClient.RequestOptions,
    ): Promise<core.WithRawResponse<void>> {
        ...
        const _response = await core.fetcher({
            ...
            queryParameters: { ..._queryParams, ...requestOptions?.queryParams },
            requestType: "json",
            body: serializers.PakeMessageRequest.jsonOrThrow(_body, {
                unrecognizedObjectKeys: "strip",
                omitUndefined: true,
            }),
            timeoutMs: (requestOptions?.timeoutInSeconds ?? this._options?.timeoutInSeconds ?? 60) * 1000,
    ...
    public nextBridgeCommands(
        runnerId: string,
        request: OpikApi.BridgeCommandNextRequest = {},
        requestOptions?: RunnersClient.RequestOptions,
    ): core.HttpResponsePromise<OpikApi.BridgeCommandBatchResponse> {
    ...
    private async __nextBridgeCommands(
        ...
        request: OpikApi.BridgeCommandNextRequest = {},
        requestOptions?: RunnersClient.RequestOptions,
    ): Promise<core.WithRawResponse<OpikApi.BridgeCommandBatchResponse>> {
        const _headers: core.Fetcher.Args["headers"] = mergeHeaders(
            this._options?.headers,
            mergeOnlyDefinedHeaders({
                "Comet-Workspace": requestOptions?.workspaceName ?? this._options?.workspaceName,
        ...
        const _response = await core.fetcher({
            ...
            queryParameters: requestOptions?.queryParams,
            requestType: "json",
            body: serializers.BridgeCommandNextRequest.jsonOrThrow(request, {
                unrecognizedObjectKeys: "strip",
                omitUndefined: true,
            }),
            timeoutMs: (requestOptions?.timeoutInSeconds ?? this._options?.timeoutInSeconds ?? 60) * 1000,
        ...
        if (_response.ok) {
            return {
                data: serializers.BridgeCommandBatchResponse.parseOrThrow(_response.body, {
                    unrecognizedObjectKeys: "passthrough",
                    allowUnrecognizedUnionMembers: true,
                    allowUnrecognizedEnumValues: true,
                    skipValidation: true,
    ...
    private async __patchChecklist(
        ...
        const _response = await core.fetcher({
            ...
            queryParameters: requestOptions?.queryParams,
            requestType: "json",
            body: serializers.runners.patchChecklist.Request.jsonOrThrow(_body, {
                unrecognizedObjectKeys: "strip",
                omitUndefined: true,
            }),
            timeoutMs: (requestOptions?.timeoutInSeconds ?? this._options?.timeoutInSeconds ?? 60) * 1000,
     ...
     *
     * @param {OpikApi.DaemonPairRegisterRequest} request
     * @param {RunnersClient.RequestOptions} requestOptions - Request-specific configuration.
     *
     * @example
     *     await client.runners.registerDaemonPair({
     *         projectId: "project_id",
     *         runnerName: "runner_name"
     *     })
     */
    public registerDaemonPair(
        request: OpikApi.DaemonPairRegisterRequest,
        requestOptions?: RunnersClient.RequestOptions,
    ): core.HttpResponsePromise<OpikApi.DaemonPairRegisterResponse> {
        return core.HttpResponsePromise.fromPromise(this.__registerDaemonPair(request, requestOptions));
    }

    private async __registerDaemonPair(
        request: OpikApi.DaemonPairRegisterRequest,
        requestOptions?: RunnersClient.RequestOptions,
    ): Promise<core.WithRawResponse<OpikApi.DaemonPairRegisterResponse>> {
        const _headers: core.Fetcher.Args["headers"] = mergeHeaders(
            this._options?.headers,
            mergeOnlyDefinedHeaders({
                "Comet-Workspace": requestOptions?.workspaceName ?? this._options?.workspaceName,
        ...
        const _response = await core.fetcher({
            ...
            queryParameters: requestOptions?.queryParams,
            requestType: "json",
            body: serializers.DaemonPairRegisterRequest.jsonOrThrow(request, {
                unrecognizedObjectKeys: "strip",
                omitUndefined: true,
            }),
            timeoutMs: (requestOptions?.timeoutInSeconds ?? this._options?.timeoutInSeconds ?? 60) * 1000,
        ...
        if (_response.ok) {
            return {
                data: serializers.DaemonPairRegisterResponse.parseOrThrow(_response.body, {
                    unrecognizedObjectKeys: "passthrough",
                    allowUnrecognizedUnionMembers: true,
                    allowUnrecognizedEnumValues: true,
                    skipValidation: true,
    ...
    public reportBridgeResult(
        ...
        return core.HttpResponsePromise.fromPromise(
            this.__reportBridgeResult(runnerId, commandId, request, requestOptions),
        );
    }

    private async __reportBridgeResult(
        runnerId: string,
        commandId: string,
        request: OpikApi.BridgeCommandResultRequest,
        requestOptions?: RunnersClient.RequestOptions,
